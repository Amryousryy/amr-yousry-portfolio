      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <motion.div
            ...
            className="relative"
          >
            <div className="relative aspect-square w-full max-w-md mx-auto rounded-xl border border-border overflow-hidden">
              <Image
            ...
            <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-accent/20 rounded-full z-[-1]" />
            <div className="absolute -top-6 -left-6 w-24 h-24 bg-accent/10 rounded-full z-[-1]" />
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-accent text-sm uppercase tracking-widest mb-4">The Strategist</h2>
            ...
            <div className="space-y-6 text-lg text-foreground/70 font-sans">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div>
                  <h4 className="text-accent text-xs uppercase tracking-widest mb-2">Experience</h4>
                  <p className="font-display font-bold text-2xl">5+ Years</p>
                </div>
                <div>
                  <h4 className="text-accent text-xs uppercase tracking-widest mb-2">Conversion</h4>
