    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-30 text-center">
        <div className="mb-6 inline-block">
          <span className="pixel-text text-accent text-sm tracking-[0.3em] bg-accent/10 px-4 py-2 pixel-border">
            Creative Strategist
          </span>
        </div>
        ...
        >
          ...
          <span className="relative inline-block group">
            clients
            <span className="absolute -bottom-2 left-0 w-full h-1 bg-primary group-hover:bg-accent transition-colors" />
          </span> for brands.
        </h1>
        ...
        <div ref={ctaRef} className="flex flex-col md:flex-row items-center justify-center gap-6">
          ...
          >
            <div className="w-12 h-12 bg-primary/20 flex items-center justify-center pixel-border group-hover:bg-accent group-hover:text-background transition-all">       
      ...
      <AnimatePresence>
        {showModal && (
          ...
          >
            ...
            <div className="w-full max-w-5xl aspect-video bg-black/90 pixel-border relative overflow-hidden">
               <div className="absolute inset-0 flex flex-col items-center justify-center space-y-4">
                 ...
                 <p className="pixel-text text-accent text-xl tracking-widest">Showreel Coming Soon</p>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center">
        <span className="pixel-text text-[10px] mb-2 opacity-50">Scroll</span>
