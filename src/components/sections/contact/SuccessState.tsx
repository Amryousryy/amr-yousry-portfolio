...
export default function SuccessState({ onReset }: SuccessStateProps) {
  return (
    <Section id="contact" className="bg-surface/95 relative py-32">
      <Container>
        <motion.div 
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.6, ease: "easeOut" }}
          className="max-w-2xl mx-auto text-center space-y-8 py-14 sm:py-20 bg-panel border-2 border-brand-cyan/30 pixel-shadow p-5 sm:p-8 md:p-12"
        >
          <motion.div
