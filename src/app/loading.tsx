...
export default function Loading() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6" role="status" aria-live="polite">
      <div className="w-48 h-1 bg-line-faint mb-6 overflow-hidden">
